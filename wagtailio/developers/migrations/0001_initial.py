            ...
            state_operations=[
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        ('icon', models.CharField(choices=[('fa-github', 'Github'), ('fa-google', 'Google'), ('fa-eye', 'Eye'), ('fa-server', 'Servers')], max_length=255)),
                        ...
                        ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='options', to='developers.DevelopersPage')),
                    ],
                    options={
