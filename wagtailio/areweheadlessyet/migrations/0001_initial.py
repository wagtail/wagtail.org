    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('strapline_text', wagtail.fields.RichTextField()),
                ('body', wagtail.fields.StreamField([('section', wagtail.blocks.StructBlock([('title', wagtail.blocks.CharBlock()), ('content', wagtail.blocks.StreamBlock([('text', wagtail.blocks.RichTextBlock()), ('link_group', wagtail.blocks.StreamBlock([('link', wagtail.blocks.StructBlock([('link', wagtail.blocks.URLBlock(required=True)), ('link_text', wagtail.blocks.CharBlock(required=True))]))]))]))])), ('news', wagtail.blocks.StreamBlock([('blog_post', wagtail.blocks.PageChooserBlock(page_type=['blog.BlogPage']))]))])),
