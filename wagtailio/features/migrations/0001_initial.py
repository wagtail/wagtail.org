            ...
            state_operations=[
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                        ('title', models.CharField(max_length=255)),
                        ('screenshot', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='images.WagtailIOImage')),
                    ],
                    options={
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='feature_aspects', to='features.FeaturePage')),
                    ],
                    options={
                ...
                migrations.AddField(
                    model_name='featureindexpagemenuoption',
                    name='page',
                    field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='secondary_menu_options', to='features.FeatureIndexPage'),
                ),
                migrations.AddField(
                    model_name='bullet',
                    name='snippet',
                    field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='bullets', to='features.FeatureAspect'),
                ),
            ],
            database_operations=[],
        )
