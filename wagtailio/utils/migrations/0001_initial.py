    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link_icon', models.TextField(max_length=50, blank=True, null=True, help_text='Optional. The code of a Fontawesome icon to display beside this link e.g fa-twitter')),
            ],
            options={
                'abstract': False,
                'ordering': ['sort_order'],
        ...
        migrations.AddField(
            ...
            name='snippet',
            field=modelcluster.fields.ParentalKey(to='utils.LinkGroupSnippet', related_name='links'),
