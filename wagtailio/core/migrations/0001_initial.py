    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', wagtail.fields.StreamField((('h2', wagtail.blocks.CharBlock(classname='title', icon='title')), ('h3', wagtail.blocks.CharBlock(classname='title', icon='title')), ('h4', wagtail.blocks.CharBlock(classname='title', icon='title')), ('intro', wagtail.blocks.RichTextBlock(icon='pilcrow')), ('paragraph', wagtail.blocks.RichTextBlock(icon='pilcrow')), ('aligned_image', wagtail.blocks.StructBlock((('image', wagtail.images.blocks.ImageChooserBlock()), ('caption', wagtail.blocks.RichTextBlock()), ('alignment', wagtailio.utils.blocks.ImageFormatChoiceBlock())), label='Aligned image', icon='image')), ('pullquote', wagtail.blocks.StructBlock((('quote', wagtail.blocks.CharBlock(classname='quote title')), ('attribution', wagtail.blocks.CharBlock(required=False))))), ('imagequote', wagtail.blocks.StructBlock((('quote', wagtail.blocks.CharBlock(classname='quote title')), ('attribution', wagtail.blocks.CharBlock(required=False)), ('image', wagtail.images.blocks.ImageChooserBlock()), ('alignment', wagtailio.utils.blocks.SimpleImageFormatChoiceBlock())), label='Image quote')), ('aligned_html', wagtail.blocks.StructBlock((('html', wagtail.blocks.RawHTMLBlock()), ('alignment', wagtailio.utils.blocks.HTMLAlignmentChoiceBlock())), label='Raw HTML', icon='code')), ('document', wagtail.documents.blocks.DocumentChooserBlock(icon='doc-full-inverse'))))),
                ('listing_image', models.ForeignKey(help_text='Image to display along with summary, when this page is linked from elsewhere in the site.', blank=True, on_delete=django.db.models.deletion.SET_NULL, to='images.WagtailIOImage', null=True, related_name='+')),
